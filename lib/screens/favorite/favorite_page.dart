...
class FavoritePage extends StatelessWidget {
  ...
  final List<MusicData> mockMusicData = [
    MusicData(
      ...
      lyrics:
          "test  lyrics  if you shy iudsgfiusdigfuisgduifgsuodgfosugdfuosgduifgsuoidgfuisdgfuisgduofgsuodgfguisdgfuisgduisgduoigdsuoiguisdguisgsuisduiguisdhgfguisdhfuishdfougsduifgusi",
    ),
    MusicData(
      ...
      lyrics: "test lyrics  cheapest flight",
    ),
  ];
